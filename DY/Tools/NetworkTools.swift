...
class NetworkTools {
    ...
    class func requestData(_ type:MethodType,URLString: String, parameters: [String:Any]? = nil, resultCallBack:@escaping ((_ result : Any)->()) , errorCallBack: ((_ error : Error)->())? = nil) {
